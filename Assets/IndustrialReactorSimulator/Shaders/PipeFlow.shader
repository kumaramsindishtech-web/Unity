...
// Version: 1.0.0
// Description: Animated flow visualization for pipes
// ============================================================================
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                // Calculate scrolling UVs for flow
                ...
                // Create flow pattern
                float flowPattern = flowSample.r;
                flowPattern = saturate(pow(flowPattern, _FlowSharpness) * _FlowIntensity);
