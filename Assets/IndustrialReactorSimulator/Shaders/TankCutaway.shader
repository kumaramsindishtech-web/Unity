...
// Version: 1.0.0
// Description: Shader with plane-based clipping for cutaway visualization
// ============================================================================
...
Shader "Industrial Reactor/Tank Cutaway"
{
    Properties
    {
        ...
        _InteriorMetallic ("Interior Metallic", Range(0, 1)) = 0.2
        _InteriorSmoothness ("Interior Smoothness", Range(0, 1)) = 0.3
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes input)
            {
                ...
                output.positionCS = posInputs.positionCS;
                output.positionWS = posInputs.positionWS;
                output.normalWS = -GetVertexNormalInputs(input.normalOS).normalWS; // Flip normal
                output.uv = input.uv;
                output.fogFactor = ComputeFogFactor(posInputs.positionCS.z);
